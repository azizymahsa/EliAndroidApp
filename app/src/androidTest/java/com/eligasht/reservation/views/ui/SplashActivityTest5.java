...
public class SplashActivityTest5 {

    @Rule
    public ActivityTestRule<SplashActivity> mActivityTestRule = new ActivityTestRule<>(SplashActivity.class);

    @Test
    public void splashActivityTest5() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
            Thread.sleep(3592859);
                ...
                allOf(withId(R.id.txtnameP),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        1),
                                1)));
        appCompatEditText4.perform(scrollTo(), replaceText("ا"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withId(R.id.linear_number_passport),
                                        childAtPosition(
                                                ...
                                                4)),
                                1)));
        appCompatEditText35.perform(scrollTo(), replaceText("d"), closeSoftKeyboard());
