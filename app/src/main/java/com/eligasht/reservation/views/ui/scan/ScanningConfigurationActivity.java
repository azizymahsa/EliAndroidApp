...
import com.eligasht.reservation.views.ui.scan.ScanModuleEnum;
...
public abstract class ScanningConfigurationActivity {/*extends AppCompatActivity {
    ...
    *//**
     * @return the module type view {@link com.eligasht.reservation.views.ui.scan.ScanModuleEnum.ScanModule}
     *//*
