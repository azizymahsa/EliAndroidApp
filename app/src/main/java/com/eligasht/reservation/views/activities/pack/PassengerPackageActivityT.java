...
import BaseActivity;
import FlightPreFactorAdapter;
import FlightPreFactorModel;
import HotelPreFactorAdapter;
import HotelPreFactorModel;
import PassangerPreFactorAdapter;
import PassengerPreFactorModel;
import ServicePreFactorAdapter;
import ServicePreFactorModel;
import PurchaseFlightResult;
import Utility;
import PassengerMosaferItems_Table;
import PassengerPartnerInfo_Table;
import CursorManager;
import MainActivity;
import GetHotelKhadmatAdapter;
import GetKhadmatAdapter;
import Header;
import CountrycodeActivity;
import NationalitycodeActivity;
import PassengerActivity;
import PassengerHotelActivity;
import SearchParvazActivity;
...
public class PassengerPackageActivityT extends BaseActivity implements Header.onSearchTextChangedListener, OnClickListener, OnItemSelectedListener {
...
/* btnAddsabad=(Button)findViewById(R.id.btnAddsabad);
        ...
        btn_pardakht_factor.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Utility.openUrlCustomTab(PassengerPackageActivityT.this, paymentUrl);
*/
/*
    ...
    private class AsyncFetchGetPreFactorDetails extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(PassengerPackageActivityT.this);
...
//for hotel==========================================================================================
                ...
                recyclerViewHotel.addItemDecoration(new DividerItemDecoration(PassengerPackageActivityT.this, 1));
                recyclerViewHotel.setLayoutManager(new LinearLayoutManager(PassengerPackageActivityT.this));
...
//for passenger======================================================================================
                ...
                recyclerViewPassenger.addItemDecoration(new DividerItemDecoration(PassengerPackageActivityT.this, 1));
                recyclerViewPassenger.setLayoutManager(new LinearLayoutManager(PassengerPackageActivityT.this));
...
/*   //for Services=============================================================================
                ...
                recyclerViewService.addItemDecoration(new DividerItemDecoration(PassengerPackageActivityT.this, 1));
                recyclerViewService.setLayoutManager(new LinearLayoutManager(PassengerPackageActivityT.this));
                ...
                recyclerViewFlight.addItemDecoration(new DividerItemDecoration(PassengerPackageActivityT.this, 1));
                recyclerViewFlight.setLayoutManager(new LinearLayoutManager(PassengerPackageActivityT.this));
                ...
                Toast.makeText(PassengerPackageActivityT.this, e.toString(), Toast.LENGTH_LONG).show();
...
*//*
                ...
                Toast.makeText(PassengerPackageActivityT.this, "ارتباط با سرور برقرار نشد !!", Toast.LENGTH_LONG).show();
            }
...
//			headerJson.put("BookingReferenceID", GUID);///ID.toString()
            ...
            //mosaferan
            PassengerMosaferItems_Table items_Table=new PassengerMosaferItems_Table(PassengerPackageActivityT.this);
            ...
            ////kharidar
            PassengerPartnerInfo_Table partnerInfo_Table=new PassengerPartnerInfo_Table(PassengerPackageActivityT.this);
...
////
            ...
            case R.id.btn_next_partnerInfo:
                ...
                try {
                    ...
                    PassengerMosaferItems_Table db = new PassengerMosaferItems_Table(PassengerPackageActivityT.this);
                    //   db.openDB();
                    db.dropTable();
                    ////////////////////////Validate
...
/*String Gender= "Female";
                ...
                if (flagMosafer.contains("F")) {
                    ...
                    if (sum > 0) {
                        ...
                        if(counter-1 ==1){
                            db.insertData(counter-1,"اطلاعات مسافر بزرگسال 1" ,imgCount.getText().toString(),Gender, Nationality, Nationality_ID, RqPassenger_Address, RqPassenger_Birthdate, RqPassenger_Email, RqPassenger_FirstNameEn, RqPassenger_FirstNameFa, RqPassenger_LastNameEn, RqPassenger_LastNameFa, RqPassenger_Mobile, RqPassenger_NationalCode, RqPassenger_PassExpDate, RqPassenger_PassNo, RqPassenger_Tel);
...
/**************************************************************
    ...
    public boolean ErrorInApi(JSONObject jsonObj) throws JSONException {
        ...
        if (GetAirportsResult.getJSONArray("Errors") != null) {
            ...
            Toast.makeText(PassengerPackageActivityT.this, errors.getJSONObject(0).getString("DetailedMessage"), Toast.LENGTH_SHORT).show();
