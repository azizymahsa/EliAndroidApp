...
public class GetCityTrainMaghsadActivity extends BaseActivity implements Header.onSearchTextChangedListener, OnClickListener, OnServiceStatus<List<ResponseTrainStation>> {
    ...
    GetTrainMaghsadAdapter mAdapter;
    ...
    public void onReady(List<ResponseTrainStation> responseTrainStations) {//get Response from api
        ...
        mAdapter = new GetTrainMaghsadAdapter(GetCityTrainMaghsadActivity.this,data, GetCityTrainMaghsadActivity.this);
    ...
    public void onError(String message) {//get Errors from api
        ...
        if (!Utility.isNetworkAvailable(GetCityTrainMaghsadActivity.this)) {
            AlertDialogPassenger AlertDialogPassenger = new AlertDialogPassenger(GetCityTrainMaghsadActivity.this,true,false);
