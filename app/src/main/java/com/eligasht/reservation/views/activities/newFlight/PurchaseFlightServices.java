...
public class PurchaseFlightServices {
    ...
    private ExcursionDetails excursionData;
    ...
    public ExcursionDetails getExcursionData() {
        return excursionData;
    }

    public void setExcursionData(ExcursionDetails excursionData) {
