...
import com.eligasht.service.model.survey.response.detail.Surveie;
import com.eligasht.service.model.survey.response.detail.SurveySection;

import java.util.List;

public class SurveyDetailsRecycleAdapter extends RecyclerView.Adapter<SurveyDetailsRecycleAdapter.ViewHolder> {

    private List<SurveySection> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    public SurveyDetailsRecycleAdapter(Context context, List<SurveySection> data) {
