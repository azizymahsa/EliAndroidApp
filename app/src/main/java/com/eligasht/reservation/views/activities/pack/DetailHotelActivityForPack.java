...
import GetHotelDetail;
import GetHoldRoom;
import GetRoomsList;
import BaseActivity;
import ImageHotel;
import GetHotelDRequest;
import GetHotelDetailRequest;
import HotelProprties;
import HoldSelectedRoomRequest;
import Identity;
import GetRoomsHotelRequest;
import com.reserv.myapplicationeli.models.hotel.api.rooms.call.IdentityRooms2;
import RoomRequest;
import RoomList;
import HotelProprtiesAdapter;
import HotelProprtiesModels;
import ImageModel;
import RoomsAdapter;
import RoomsModel;
import InitUi;
import NonScrollGridView;
import PassengerHotelActivity;
import ViewPagerAttention;

import java.util.ArrayList;


public class DetailHotelActivityForPack extends BaseActivity implements View.OnClickListener, OnMapReadyCallback {
...
/*  map.setTrafficEnabled(true);
    ...
    private class GetRoomsAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            new InitUi().Loading(DetailHotelActivityForPack.this,rlLoading, rlRoot, true, R.drawable.hotel_loading);
        ...
        protected void onPostExecute(String result) {
          ...
          //      new GetHoldDetailAsync().execute();
                ...
                Toast.makeText(DetailHotelActivityForPack.this, "خطا در ارتباط", Toast.LENGTH_SHORT).show();
                finish();
            }
    ...
    private class GetHoldRoomAsync extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            new InitUi().Loading(DetailHotelActivityForPack.this,rlLoading, rlRoot, false, R.drawable.hotel_loading);
            window.setStatusBarColor(getColor(R.color.colorPrimaryDark));
            try {
                int i = 0;
                ...
                Intent intent = new Intent(DetailHotelActivityForPack.this, PassengerHotelActivity.class);
...
/*  window.setStatusBarColor(getColor(R.color.blue2));
        ...
        protected void onPostExecute(String result) {
            ...
            ImageLoader.getInstance().init(ImageLoaderConfiguration.createDefault(DetailHotelActivityForPack.this));
...
/*   new InitUi().Loading(rlLoading, rlRoot, false);
       ...
       try {
         ...
         hotelProprtiesAdapter.notifyDataSetChanged();
             new ViewPagerAttention(DetailHotelActivityForPack.this,imageModels, R.id.intro_view_pager);
             ...
             switch (getHotelDetail.getHotelDetailResult.GetHotelDetailResult.HotelDetail.StarRating){
                 ...
                 case 1:
                     //todo change this
                    ivImage.setImageDrawable(ContextCompat.getDrawable(DetailHotelActivityForPack.this, R.drawable._1star));

                     break;
                 case 2:
                    ivImage.setImageDrawable(ContextCompat.getDrawable(DetailHotelActivityForPack.this, R.drawable._2star));

                     break;
                 case 3:
                    ivImage.setImageDrawable(ContextCompat.getDrawable(DetailHotelActivityForPack.this, R.drawable._3star));

                     break;
                 case 4:
                    ivImage.setImageDrawable(ContextCompat.getDrawable(DetailHotelActivityForPack.this, R.drawable._4star));

                     break;

                 case 5:
                    ivImage.setImageDrawable(ContextCompat.getDrawable(DetailHotelActivityForPack.this, R.drawable._5star));
