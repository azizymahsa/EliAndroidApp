...
public class GetTrainMaghsadAdapter extends BaseAdapter {
 ...
 /*   public GetTrainMaghsadAdapter(Context context, List<Country> data, Activity activity) {
    ...
    public GetTrainMaghsadAdapter(Activity activity) {
