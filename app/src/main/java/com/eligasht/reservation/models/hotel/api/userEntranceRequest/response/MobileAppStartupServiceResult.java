...
public class MobileAppStartupServiceResult {
    ...
    public MobileAppStartupServiceResult(String minAppVersion, boolean canEnter, List<com.eligasht.reservation.models.hotel.api.userEntranceRequest.response.SearchNotes> searchNotes) {
