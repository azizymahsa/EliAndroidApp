...
public class Contract {
    ...
    public Contract(Integer agcUserID, String agencyName, String agencyNameFa, String airline, Integer baxID, String baxName, Integer cashierEventPriceBed, Integer cashierEventPriceBes, String checkDate, String checkUserName, String checkin, Integer cntAduQty, Integer cntChd26Qty, Integer cntChd612Qty, Integer cntDiscount, Integer cntDocDeliver, String cntDocDeliverDate, String cntDocDeliverDateFa, Integer cntDocDeliverUserID, int cntID, Integer cntInfQty, Integer cntPID, String cntPartnerName, Integer cntRevision, Integer cntStatusTypeID, Integer cntTotalPlusCom, Integer companyID, String companyName, String contractPrintURL, String customerEmail, String customerFax, String customerMobile, String customerName, String customerPhone, String date, String dateFa, String deliverUserName, String departure, String description, Integer discount, String editModifiedDate, Integer editStatusID, String editUserEn, String editUserFa, String editUserID, String editValidDate, String encryptedCnt_ID, String encryptedOldCnt_ID, Integer finEventPrice, String finEventSarfaslCode, Integer finalCom, Integer finalDiscount, Integer finalPrice, String fincCenterID, Integer fltType, Integer followerID, String followerName, boolean hasFlt, boolean hasHotel, boolean hasIns, boolean hasService, boolean hasVisa, Integer hotelConfirm, Integer hotelIssue, Integer hotelPenalty, String insurancePrintURL, Integer anInt, Integer isChecked, Integer loginTypeID, String loginTypeName, String loungePrintURL, String modifyDate, String modifyDateFa, String modifyUser, Integer modifyUserID, Integer note, int oldCntID, Integer oldCustomerID, Integer oldStatusID, String origin, String packName, String aPackage, Long pageSize, Integer pardakhti, Integer partnerID, String pathNames, Integer pax, String paymentURL, Integer penalty, String refNo, Integer remained, String remainedResult, String roomDescription, Integer rooms, int rowNumber, Integer rqBaseID, String serviceVoucherPrintURL, String status, String statusText, String statusTime, String statusTimeFa, String statusUser, Integer statusUserID, Integer taxPercent, Integer taxPrice, Integer ticketConfirm, Integer ticketDescription, Integer ticketIssue, TTicket tickets, Integer tktQty, Integer totalCommision, Integer totalPrice, String type, Integer visaConfirm, String visaDescription, Integer visaIssue, String visaPrintURL, Integer visaQty, String voucherPrintURL, Integer web, Integer webEndUser, Integer webUserID, String webUserName) {
        AgcUserID = agcUserID;
        AgencyName = agencyName;
        AgencyNameFa = agencyNameFa;
        Airline = airline;
        BaxID = baxID;
        BaxName = baxName;
        CashierEventPriceBed = cashierEventPriceBed;
        CashierEventPriceBes = cashierEventPriceBes;
        CheckDate = checkDate;
        CheckUserName = checkUserName;
        Checkin = checkin;
        CntAduQty = cntAduQty;
        CntChd26Qty = cntChd26Qty;
        CntChd612Qty = cntChd612Qty;
        CntDiscount = cntDiscount;
        CntDocDeliver = cntDocDeliver;
        CntDocDeliverDate = cntDocDeliverDate;
        CntDocDeliverDateFa = cntDocDeliverDateFa;
        CntDocDeliverUserID = cntDocDeliverUserID;
        CntID = cntID;
        CntInfQty = cntInfQty;
        CntPID = cntPID;
        CntPartnerName = cntPartnerName;
        CntRevision = cntRevision;
        CntStatusTypeID = cntStatusTypeID;
        CntTotalPlusCom = cntTotalPlusCom;
        CompanyID = companyID;
        CompanyName = companyName;
        ContractPrintURL = contractPrintURL;
        ...
        Discount = discount;
        EditModifiedDate = editModifiedDate;
        EditStatusID = editStatusID;
        EditUserEn = editUserEn;
        EditUserFa = editUserFa;
        EditUserID = editUserID;
        EditValidDate = editValidDate;
        EncryptedCnt_ID = encryptedCnt_ID;
        EncryptedOldCnt_ID = encryptedOldCnt_ID;
        FinEventPrice = finEventPrice;
        FinEventSarfaslCode = finEventSarfaslCode;
        FinalCom = finalCom;
        FinalDiscount = finalDiscount;
        FinalPrice = finalPrice;
        FincCenterID = fincCenterID;
        FltType = fltType;
        ...
        HotelIssue = hotelIssue;
        HotelPenalty = hotelPenalty;
        InsurancePrintURL = insurancePrintURL;
        Int = anInt;
        IsChecked = isChecked;
        LoginTypeID = loginTypeID;
        LoginTypeName = loginTypeName;
        LoungePrintURL = loungePrintURL;
        ModifyDate = modifyDate;
        ModifyDateFa = modifyDateFa;
        ...
        RefNo = refNo;
        Remained = remained;
        RemainedResult = remainedResult;
        RoomDescription = roomDescription;
        Rooms = rooms;
        RowNumber = rowNumber;
        RqBaseID = rqBaseID;
        ServiceVoucherPrintURL = serviceVoucherPrintURL;
        Status = status;
        StatusText = statusText;
        StatusTime = statusTime;
        StatusTimeFa = statusTimeFa;
        ...
        Type = type;
        VisaConfirm = visaConfirm;
        VisaDescription = visaDescription;
        VisaIssue = visaIssue;
        VisaPrintURL = visaPrintURL;
        VisaQty = visaQty;
        VoucherPrintURL = voucherPrintURL;
        Web = web;
        WebEndUser = webEndUser;
        WebUserID = webUserID;
