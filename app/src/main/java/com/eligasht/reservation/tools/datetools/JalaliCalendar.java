...
public class JalaliCalendar extends Calendar {
    ...
    public static int         jalaliDaysInMonth[]    = { 31, 31, 31, 31, 31, 31, 30, 30,
                                                     30, 30, 30, 29 };
    private String[] MonthMiladi = new String[]{ "Jan", "Feb", "Mar", "Apr", "May", "Jun ", "Jul", "Aug", "Sep", "October", "Nov", "Dec" };
    private String[] MonthJalali = new String[]{ "Jan", "Feb", "Mar", "Apr", "May", "Jun ", "Jul", "Aug", "Sep", "October", "Nov", "Dec" };
    private String[] DayOfWeekEn   = new String[]{ "Sun", " Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
    private String[] DayOfWeekFr   = new String[]{ "Sun", " Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
    ...
    public void getGregorianDate(int year, int month, int day) {
        //  String[] arr = jalaliDate.split("/");

        YearMonthDate jalali = new YearMonthDate(year, month - 1, day);
    ...
    public void setMiladiDate(int year, int month, int day) {
    ...
    public int getJDayOfWeek() {
        return dayOfWeek;
    }


    public String getNameMDayOfWeek() {
        return DayOfWeekEn[dayOfWeek];
    }

    public String getNameJDayOfWeek() {
        return DayOfWeekFr[dayOfWeek];
    }
    ...
    public String getNameJmonth() {
        return MonthJalali[jMonth - 1];
    }


    public String getNameMmonth() {
        return MonthMiladi[MMonth];
    }
