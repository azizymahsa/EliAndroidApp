...
//		btn_khadamat.setOnClickListener(this);
	...
	private class AsyncFetchGetPreFactorDetails extends AsyncTask<String, String, String> {
		ProgressDialog pdLoading = new ProgressDialog(PassengerPackageActivity.this);
...
////////////////////////////
				...
				// Getting JSON Array node
				JSONObject GetAirportsResult = jsonObj.getJSONObject("PurchasePackageResult");//Error
