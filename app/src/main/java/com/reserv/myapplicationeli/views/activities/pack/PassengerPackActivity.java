...
/**
 * Created by elham.bonyani on 1/9/2018.
 */

public class PassengerPackActivity extends BaseActivity implements Header.onSearchTextChangedListener,OnClickListener,OnItemSelectedListener{
        ...
        private class AsyncFetchGetPreFactorDetails extends AsyncTask<String, String, String> {
            ProgressDialog pdLoading = new ProgressDialog(PassengerPackActivity.this);
...
////////////////////////////
                    ...
                    Toast.makeText(PassengerPackActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
...
////////////////////////////
                    ...
                    if(successResult==0){
                        ...
                        Toast.makeText(PassengerPackActivity.this, message, Toast.LENGTH_LONG).show();
                    }
...
////////////////////////////
				 ...
				 /* JSONObject GetError = jsonObj.getJSONObject("Error");
				  Toast.makeText(PassengerActivity.this,  Get, Toast.LENGTH_LONG).show();*/
                    ...
                    mAdapter = new GetKhadmatAdapter(PassengerPackActivity.this, data,PassengerPackActivity.this);
        ...
        public String OrderToJson() {
            ...
            try {
                ...
                //mosaferan
                PassengerMosaferItems_Table items_Table=new PassengerMosaferItems_Table(PassengerPackActivity.this);
                ...
                ////kharidar
                PassengerPartnerInfo_Table partnerInfo_Table=new PassengerPartnerInfo_Table(PassengerPackActivity.this);
...
////
                ...
                case R.id.btn_next_partnerInfo:
                    ...
                    try{
                        ...
                        PassengerMosaferItems_Table db = new PassengerMosaferItems_Table(PassengerPackActivity.this);
                        //   db.openDB();
                        db.dropTable();
                        ////////////////////////Validate
