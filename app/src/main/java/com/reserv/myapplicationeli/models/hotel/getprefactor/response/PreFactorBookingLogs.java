...
public class PreFactorBookingLogs {
    ...
    public PreFactorBookingLogs(List<com.reserv.myapplicationeli.models.hotel.getprefactor.response.BookingActionsList> bookingActionsList, boolean successBooking) {
