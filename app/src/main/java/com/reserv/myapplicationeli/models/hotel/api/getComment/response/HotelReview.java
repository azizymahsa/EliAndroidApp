...
public class HotelReview {
    ...
    public HotelReview(String hotelName, String hotelID, com.reserv.myapplicationeli.models.hotel.api.getComment.response.AverageReviewScores[] averageReviewScores, String reviewsCount, com.reserv.myapplicationeli.models.hotel.api.getComment.response.Reviews[] reviews, com.reserv.myapplicationeli.models.hotel.api.getComment.response.ReviewFilterItems[] reviewFilterItems, String recommendedPercent, String averageScore) {
        HotelName = hotelName;
        HotelID = hotelID;
