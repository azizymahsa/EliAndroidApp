...
import com.reserv.myapplicationeli.slidingmenu.adapter.GetKhadmatAdapter;
import com.reserv.myapplicationeli.slidingmenu.customViews.Header.onSearchTextChangedListener;
import com.reserv.myapplicationeli.slidingmenu.db.local.PassengerMosaferItems_Table;
import com.reserv.myapplicationeli.slidingmenu.db.local.PassengerPartnerInfo_Table;
import com.reserv.myapplicationeli.slidingmenu.db.main.CursorManager;

public class PassengerActivity extends Activity implements onSearchTextChangedListener,OnClickListener,OnItemSelectedListener{
