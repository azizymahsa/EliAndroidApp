...
import com.reserv.myapplicationeli.slidingmenu.ui.SearchParvazActivity.HeaderExpandingPlan;
import com.reserv.myapplicationeli.slidingmenu.ui.SearchParvazActivity.ItemExpandingPlan;
import com.reserv.myapplicationeli.slidingmenu.ui.SearchParvazActivity.ParentItemExpandingPlan;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	List<ParentItemExpandingPlan>  dataExpandingList;

	public ExpandableListAdapter(Context context,List<ParentItemExpandingPlan> dataList) {
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		final ItemExpandingPlan item = this.dataExpandingList.get(groupPosition).Items.get(childPosition);
...
/*	public int getChildrenCount(int groupPosition) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,View convertView, ViewGroup parent) {
		...
		ArrayList<HeaderExpandingPlan> item2 = this.dataExpandingList.get(groupPosition).Header;
