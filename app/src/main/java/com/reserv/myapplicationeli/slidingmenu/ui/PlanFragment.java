package com.reserv.myapplicationeli.slidingmenu.ui;
...
public class PlanFragment extends Activity implements OnClickListener {
	public PlanFragment() {
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_plane);
		...
		Typeface face = Typeface.createFromAsset(getAssets(),"fonts/irsans.ttf");



		tarikh_az_picker= (Button) findViewById(R.id.tarikh_az_picker);
		tarikh_be_picker= (Button) findViewById(R.id.tarikh_be_picker);
    /*tarikh_az_picker.setTypeface(face);
    tarikh_be_picker.setTypeface(face);*/

		tarikh_az= (Button) findViewById(R.id.tarikh_az);
		tarikh_be= (Button) findViewById(R.id.tarikh_be);
		tarikh_az.setTypeface(face);
		tarikh_be.setTypeface(face);

		btnPlusB= (Button) findViewById(R.id.btnPlusB);
		btnMinesB= (Button) findViewById(R.id.btnMinesB);

		btnPlusK= (Button) findViewById(R.id.btnPlusK);
		btnMinesK= (Button) findViewById(R.id.btnMinesK);

		btnPlusN= (Button) findViewById(R.id.btnPlusN);
		btnMinesN= (Button) findViewById(R.id.btnMinesN);

		btntwo= (Button) findViewById(R.id.btntwo);
		btnOne= (Button) findViewById(R.id.btnOne);
		btntwo.setTypeface(face);
		btnOne.setTypeface(face);

		searchPlan= (Button) findViewById(R.id.searchPlan);
		searchPlan.setTypeface(face);
		txtBO=(TextView) findViewById(R.id.txtBO);
		txtKO=(TextView) findViewById(R.id.txtKO);
		txtNO=(TextView) findViewById(R.id.txtNO);
		txtBO.setTypeface(face);
		txtKO.setTypeface(face);
		txtNO.setTypeface(face);
		textView3=(TextView) findViewById(R.id.textView3);
		textView3.setTypeface(face);
		txtCountB=(TextView) findViewById(R.id.txtCountB);
		txtCountK=(TextView) findViewById(R.id.txtCountK);
		txtCountN=(TextView) findViewById(R.id.txtCountN);
		tvStart=(TextView) findViewById(R.id.tvStart);
		tvStart.setTypeface(face);

		txtOption=(TextView) findViewById(R.id.txtOption);
		tvEnd=(TextView) findViewById(R.id.tvEnd);
		tvEnd.setTypeface(face);
		lbl_forudgah_mabda=(TextView) findViewById(R.id.lbl_forudgah_mabda);
		lbl_forudgah_maghsad=(TextView) findViewById(R.id.lbl_forudgah_maghsad);
		lbl_forudgah_mabda.setTypeface(face);
		lbl_forudgah_maghsad.setTypeface(face);
		...
		switch (v.getId()) {
			...
			case R.id.btnPlusB:
				...
				if(countNafar<9){
					...
					{
						e.printStackTrace();
						Toast.makeText(this,"Some error :(",2000).show();
					}
				}
				break;
			case R.id.btnMinesB:
				...
				{
					e.printStackTrace();
					Toast.makeText(this,"Some errors :(",2000).show();
				}
				break;
			...
			case R.id.tvEnd:
				...
				Intent i3 = new Intent(this,GetAirportMaghsadActivity.class);
				Bundle bundle = getIntent().getExtras();
				if(bundle != null ){
			...
			case R.id.btntwo:
				...
				((Button)findViewById(R.id.btnOne)).setBackgroundResource(R.drawable.raft_big);
				((Button)findViewById(R.id.btntwo)).setTextColor(Color.parseColor("#ffffff"));
				((Button)findViewById(R.id.btnOne)).setTextColor(Color.parseColor("#d9d9d9"));

				linear_picker_title = (LinearLayout) findViewById(R.id.linear_picker_title);
				linear_picker = (LinearLayout) findViewById(R.id.linear_picker);
			...
			/*((Button)findViewById(R.id.btnAward)).setBackgroundDrawable(R.drawable.background_back);
			((Button)findViewById(R.id.btntwo)).setTextColor(Color.parseColor("#E06F3"));
			((Button)findViewById(R.id.btnOne)).setTextColor(Color.parseColor("#ffffff"));*/
				break;
			case R.id.btnOne:
				flagOneTwo=1;
				((Button)findViewById(R.id.btnOne)).setBackgroundResource(R.drawable.purple_button_larg);
				((Button)findViewById(R.id.btntwo)).setBackgroundResource(R.drawable.raft_big);
				((Button)findViewById(R.id.btnOne)).setTextColor(Color.parseColor("#ffffff"));
				((Button)findViewById(R.id.btntwo)).setTextColor(Color.parseColor("#d9d9d9"));
			...
			case R.id.searchPlan:
				...
				Intent intent1 = new Intent(this,SearchParvazActivity.class);
