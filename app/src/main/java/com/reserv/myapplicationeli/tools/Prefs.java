...
public final class Prefs {
    ...
    public static void putObject(String serializedObjectKey, Object object) {
        final SharedPreferences.Editor sharedPreferencesEditor = getPreferences().edit();
    ...
    @Nullable
    public static <GenericClass> GenericClass getObject(String preferenceKey, Class<GenericClass> classType) {
        if ( getPreferences().contains(preferenceKey)) {
            Gson gson = new GsonBuilder().create();
            return gson.fromJson( getPreferences().getString(preferenceKey, ""), classType);
        }
        return null;
    }

    public static void putArray(String serializedObjectKey, ArrayList arrayList) {
        final SharedPreferences.Editor sharedPreferencesEditor = getPreferences().edit();
        Gson gson = new GsonBuilder().create();
    ...
    @Nullable
    public static <T> ArrayList<T> getArray(String preferenceKey,Type typeOfT) {
        if (getPreferences().contains(preferenceKey)) {
            Gson gson = new GsonBuilder().create();
            return  gson.fromJson(getPreferences().getString(preferenceKey, ""), typeOfT);
        }
        return null;
    }
