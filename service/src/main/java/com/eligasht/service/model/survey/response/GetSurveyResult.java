...
public class GetSurveyResult {
    ...
    @Expose
    private List<SurveyStatus_> surveyStatuses = null;
    ...
    public List<SurveyStatus_> getSurveyStatuses() {
        return surveyStatuses;
    }

    public void setSurveyStatuses(List<SurveyStatus_> surveyStatuses) {
