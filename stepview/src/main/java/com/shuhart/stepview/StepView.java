...
public class StepView extends View {
    ...
    private void applyStyles(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        defaultCircleColor = ta.getColor(R.styleable.StepView_sv_defaultCircleColor, 0);
    ...
    public class State {
        ...
        @ColorInt
        private int defaultCircleColor = StepView.this.defaultCircleColor;
        @Dimension
        ...
        public State defaultCircleColor(@ColorInt int defaultCircleColor) {
        ...
        public void commit() {
            ...
            StepView.this.selectedTextColor = selectedTextColor;
            StepView.this.doneCircleColor = doneCircleColor;//defaultCircleColor
            StepView.this.defaultCircleColor = defaultCircleColor;
